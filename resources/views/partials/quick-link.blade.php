...
<div class="flex flex-col md:flex-row md:justify-between md:items-end flex-wrap gap-4">
    ...
    <div class="grid">
        <div
                @class([
                    'flex items-center gap-x-2 ring-1 ring-inset rounded-full pr-4 whitespace-nowrap py-1.5 pl-3 w-min dark:bg-gray-800 dark:ring-white/10 dark:text-slate-100',
                    match ($descriptionColor) {
...
//                        'gray' => '',
        ...
        <div
                class="fi-wi-stats-overview-stat-value mt-5 text-3xl font-semibold tracking-tight text-gray-950 dark:text-white"
        >
            {{ $getValue() }}
        </div>
